...
export default function Contact() {
            ...
            <div className="h-100" style={styles.background}>
                ...
                <div className="d-lg-flex px-3">
                    <div className="card col-lg-6 m-auto form-container" style={styles.form}>
                        <form className="form-group p-3 contact-form" autoComplete='on' onSubmit={handleSubmit}>
                            <div className="mb-3">
                            ...
                            <div className="mb-3">                                              <textarea className="form-control" style={styles.input} id="message" placeholder="Message" rows="3"></textarea>
                                <div className="invalid-feedback">
    ...
    //                     <h2 className="p-5" style={styles.text}>Contact Me</h2>
    //                     <div className="d-lg-flex px-3">
    //                         <card className="card col-lg-6 m-auto" style={styles.form}>
    //                         {/* onSubmit={handleSubmit} */}
    //                             <form className="form-group p-3 needs-validation" novalidate autoComplete='on' >
    //                                 <div className="mb-3">
    //                                     <input type="text" className="form-control" style={styles.input} id="name" placeholder="Name" required />
    //                                     <div className="invalid-feedback">
    //                                         Please provide your name.
    //                                     </div>
    //                                 </div>
    //                                 <div className="mb-3">
    //                                     <input type="email" className="form-control" style={styles.input} id="email" placeholder="Email address" required />
    //                                     <div className="invalid-feedback">
    //                                         Please provide your email.
    //                                     </div>
    //                                 </div>
    //                                 <div className="mb-3">
    //                                     <input type="text" className="form-control" style={styles.input} id="subject" placeholder="Subject" required />
    //                                     <div className="invalid-feedback">
    //                                         Please provide an email subject.
    //                                     </div>
    //                                 </div>
    //                                 <div className="mb-3">
    //                                     <textarea className="form-control" style={styles.input} id="message" placeholder="Message" rows="3"
    //                                         required></textarea>
    //                                     <div className="invalid-feedback">
    //                                         Please provide a message.
    //                                     </div>
    //                                 </div>
    //                                 <div className="text-center mt-3">
    //                                     <button type="submit" className="btn" id="email-btn" style={styles.button}>{status}</button>
    //                                 </div>
    //                             </form>
    //                         </card>
    //                         <nav className="col-lg-3 m-auto">
    //                             <address className=" m-3">
    //                                 {/* <i className="fas fa-phone-alt fa-lg m-3" style="color:slategray"></i> */}
    //                                 <a href="tel:6479812121" className="text-decoration-none" style={styles.text}>+1 (647) 981-2121</a>
    //                             </address>
    //                             <address className=" m-3" style={styles.text}>
    //                                 {/* <i className="fas fa-map-pin fa-lg m-3" style="color:slategray"></i> */}
    //                                 655 Vanessa Crescent <br />
    //                                 Mississauga, ON L5H
    //                                 2N5 <br /> Canada
    //                             </address>
    //                             <address className=" m-3">
    //                                 {/* <i className="fas fa-envelope fa-lg m-3" style="color:slategray"></i> */}
    //                                 <a href="mailto:madeline.e.lowes@gmail.com" className="text-decoration-none" style={styles.text}>madeline.e.lowes@gmail.com</a>
    //                             </address>
