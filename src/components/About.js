...
export default function About() {
    return (
        <div class="h-100" style={styles.background}>
            <h2 class="pt-5" style={styles.text}>About Me</h2>
            <div class="d-sm-flex justify-content-evenly align-items-center">
                <div class="col-sm-6 col-md-6">
                    <div class="container my-3" style={styles.text}>
                        <h3>Full Stack Coding Bootcamp Student</h3>
                        <h4>Graduating April 2023</h4>
                        <p>elevator pitch will go here</p>
                    </div>
                </div>
                <div class="col-md-4 col-lg-3 col-xl-2 mx-3 px-3">
                    <img class="img-fluid rounded-circle" src={'4.png'} alt="Madeline"></img>
                </div>
            </div>
            <div class="container pb-5 mb-5">
            <div class="pt-2 px-1 my-5" style={styles.border}>
